...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, output_stride=16, num_classes=1000, zero_init_residual=False,
...
def _resnet(arch, block, layers, pretrained, **kwargs):
    ...
    if pretrained:
        pre_dict = model_zoo.load_url(model_urls[arch])
        model_dict = {}
